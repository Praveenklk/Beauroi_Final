...
export function ExpandableCardDemo() {
  ...
  return (
    <>
      ...
      <ul className="max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-4 items-start gap-2">
...
const cards = [
  ...
  {
    description: "Click Here To Know More",
    title: "Data & Analyticstrsdasfadgd",
    src: "https://assets.aceternity.com/demos/aap-ka-suroor.jpeg",
    ctaText: "Visit",
    ctaLink: "https://ui.aceternity.com/templates",
    content: () => {
  ...
  {
    description: "Click Here To Know More",
    title: "Data & Analyticstrsgsdfdgfdasfadgd",
    src: "https://assets.aceternity.com/demos/aap-ka-suroor.jpeg",
    ctaText: "Visit",
    ctaLink: "https://ui.aceternity.com/templates",
    content: () => {
  ...
  {
    description: "Click Here To Know More",
    title: "Data & Analyticstrsdasfsdafasfadgd",
    src: "https://assets.aceternity.com/demos/aap-ka-suroor.jpeg",
    ctaText: "Visit",
    ctaLink: "https://ui.aceternity.com/templates",
    content: () => {
